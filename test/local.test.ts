...
import { ClientConfig, createClient, DynamoDBClient } from "../mod.ts";
...
Deno.test("Using The Local Dynamo DB Service", async (setup) => {
  await setup.step("Setup A. Ensure Local DB Resoruces on FS", async () => {
